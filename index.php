                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                      ...
                      <li> <a href="auth/" target="_blank">LOG IN</a> </li>
                     </ul>
                   </nav>
                 </div>
               </div> 
               <div class="mean-last">
                       <a href="#"><img src="assets_frontend/images/search_icon.png" alt="#" /></a> <a href="#">login/sing up</a></div>              
             </div>
           </div>
         </div>
       </div>
                  ...
                  <div class="address">
                    ...
                    <ul class="loca">
                      <li>
                        ...
                        <li>
                          <a href="#"><img src="assets_frontend/icon/email.png" alt="#" /></a>demo@gmail.com </li>
                          <li>
                            <a href="#"><img src="assets_frontend/icon/call.png" alt="#" /></a>+12586954775 </li>
                          </ul>
